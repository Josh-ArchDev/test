...
try 
{
    ...
    ### Update the <Archive Location/SAS Token> with the SAS token for the proper download of the app binaries ###
    c:\\ImageBuild\\azcopy.exe copy '<Archive Location/SAS Token>' 'c:\\ImageBuild\\' --recursive=true   
